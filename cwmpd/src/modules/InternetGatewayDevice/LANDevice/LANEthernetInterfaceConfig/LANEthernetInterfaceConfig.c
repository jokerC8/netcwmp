int  cpe_refresh_igd_lanethernetinterfaceconfig(cwmp_t * cwmp, parameter_node_t * param_node, callback_register_func_t callback_reg)
{
    ...
    if(child_param)
    {
        ...
        parameter_node_t * lan3_param;
        cwmp_model_copy_parameter(param_node, &lan3_param, 3);
        parameter_node_t * lan4_param;
        cwmp_model_copy_parameter(param_node, &lan4_param, 4);
